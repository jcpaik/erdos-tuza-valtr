...
begin
  ...
  { use [[a, x, c], a :: (c3 ++ [c])],
    ...
    rw ←eq_c2, apply lab.extend_left_cup sab; try {tauto},
    rw ←eq_c2 at hc2, exact (C.ncup_tail hc2).left,
